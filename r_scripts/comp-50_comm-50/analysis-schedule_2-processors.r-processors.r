...
#OCT + Insertion
Model_OCTIns_Stand = lm(Data$oct.insertion ~  Data$size + Data$levels.parallel) 
...
Model_OCTOCT_500 = lm(Data500$oct.oct_schedule ~ Data500$levels) #SIGN

summary(Model_OCTOCT_Stand)
summary(Model_OCTOCT_500)
...
#Rand + Greedy
Model_RandGreedy = lm(Data$random.greedy ~ Data$edges) 
summary(Model_RandGreedy)

##############################################################################################################################

#Rand + OCT Schedule
Model_RandOCTSchedule = lm(Data$oct.oct_schedule ~ Data$levels.parallel + Data$size) 
